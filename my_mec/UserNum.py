...
# 导入excel文件，以及第几张表
data = xlrd.open_workbook('D:\Program Files\Anaconda3\Lib\site-packages\gym\envs\my_mec\log\Datas59\PDQN_N1.xlsx') # AllRecords3SB1 PDQN_F1
table = data.sheets()[0]
...
# #---B------------
# ax.set_aspect(0.10)
# plt.xlim(xmin=9, xmax=26)     # I-PDQN
# ## plt.xlim(xmin=14, xmax=31)  # P-DQN
# plt.ylim(ymin=20, ymax=105)   # P-DQN
...
###3 plt.errorbar(xAxis, tF, yerr=dF, label='DQN', linestyle='dashdot', color='#ff81c0')  # , color='y'
