...
def rand_action(state):
    ...
    param = np.random.uniform(0.5, 1)  # 生成资源分配的参数 [0,1),保留三位小数
...
if __name__ == '__main__':
    ...
    f = open('./log/B/100N_rnd_30M.csv', 'w', encoding='utf-8', newline="")  # 这个文件用于存放实验过程中的输出情况
    ...
    # nohup python rand_action.py >./log/B/100N_rnd_30M.log 2>&1&