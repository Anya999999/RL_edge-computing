...
from HTR import HTR_choose_action
    ...
    def forward(self, state, action_parameters):
        ...
        for i in range(0, num_layers - 1):
            if self.activation == "sigmoid":
                ...
                x = (torch.tanh(self.layers[i](x))+1)/2
            elif self.activation == "leaky_relu":
                x = F.leaky_relu(self.layers[i](x), negative_slope)
            else:
                raise ValueError("Unknown activation function " + str(self.activation))
        Q = self.layers[-1](x)
        # print("Q__________________________", Q)
        # print("-----------------hello------------------", Q.size())
        return Q
...
class PDQNAgent(Agent):
    ...
    def __init__(self,
                 ...
                 # leaning_rate_actor_final=0.0001,
                 learning_rate_actor_param=0.0001,  # 0.00001
                 # learning_rate_actor_param_final=0.00001,
                 # learning_rate_step= 8000,
        ...
        # self.action_space.spaces[i].shape[0] is 1
        ...
        # self.leaning_rate_actor_final = leaning_rate_actor_final
        # self.learning_rate_actor_param_final = learning_rate_actor_param_final
        ...
        # self.learning_rate_actor *= 0.999
        ...
        # torch.optim.lr_scheduler.ExponentialLR(self.actor_param_optimiser, gamma=0.99, last_epoch=-1, verbose=True)
        # self.learning_rate_actor_param *= 0.999
    ...
    def lr_adjust(self, epoch):
        learning_rate_actor_final = 1e-4
        learning_rate_actor_param_final = 1e-5
        # #
        # # # torch.optim.lr_scheduler.ExponentialLR(self.actor_param_optimiser, gamma=0.1, last_epoch=-1)
        # # # torch.optim.lr_scheduler.ExponentialLR(self.actor_optimiser, gamma=0.1, last_epoch=-1)
        # # # for i in range(epoc
        # # #     if i % 1000 == 0:
        self.learning_rate_actor_param = self.learning_rate_actor_param * pow(0.9999, epoch)     # 0.99999
        self.learning_rate_actor = self.learning_rate_actor * pow(0.9999, epoch)
        if self.learning_rate_actor_param < learning_rate_actor_param_final:
            self.learning_rate_actor_param = learning_rate_actor_param_final
        if self.learning_rate_actor < learning_rate_actor_final:
            self.learning_rate_actor = learning_rate_actor_final
        # print("learning rate:-----------------", self.learning_rate_actor, self.learning_rate_actor_param)
